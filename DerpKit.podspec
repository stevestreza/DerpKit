#
# Be sure to run `pod spec lint DerpKit.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  s.name         = "DerpKit"
  s.version      = "0.0.1"
  s.summary      = "A short description of DerpKit."
  # s.description  = <<-DESC
  #                   An optional longer description of DerpKit
  #
  #                   * Markdonw format.
  ...
  # s.authors      = { "Steve Streza" => "stevestreza@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Steve Streza', 'other author'

  # Specify the location from where the source should be retreived.
  #
  s.source       = { :git => "https://github.com/amazingsyco/DerpKit.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/DerpKit/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/DerpKit', :revision => '1.0.0' }
